...
Public Sub InitDirect3D8()
    ...
    SetLoadStatus LoadStateD3D8, 25
    ...
    SetLoadStatus LoadStateD3D8, 50
    
    ' Cache the textures
    Call CacheTextures
    
    SetLoadStatus LoadStateD3D8, 75
    
    ' Begin initialising the full engine
    Call InitRenderStates
    
    SetLoadStatus LoadStateD3D8, 100
...
Public Function InitD3DDevice8() As Boolean
    ...
    Select Case Options.device
        ' Hardware Rendering
        Case 1
            Set D3DDevice8 = Direct3D8.CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, frmEditor.picMapEditor.hWnd, D3DCREATE_HARDWARE_VERTEXPROCESSING, D3DWindow)
            InitD3DDevice8 = True
            Exit Function
        ' Software Rendering
        Case 2
            Set D3DDevice8 = Direct3D8.CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, frmEditor.picMapEditor.hWnd, D3DCREATE_SOFTWARE_VERTEXPROCESSING, D3DWindow)
            InitD3DDevice8 = True
            Exit Function
        ' Mixed Rendering
        Case 3
            Set D3DDevice8 = Direct3D8.CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, frmEditor.picMapEditor.hWnd, D3DCREATE_MIXED_VERTEXPROCESSING, D3DWindow)
            InitD3DDevice8 = True
            Exit Function
        ' Pure Rendering
        Case 4
            Set D3DDevice8 = Direct3D8.CreateDevice(D3DADAPTER_DEFAULT, D3DDEVTYPE_HAL, frmEditor.picMapEditor.hWnd, D3DCREATE_PUREDEVICE, D3DWindow)
            InitD3DDevice8 = True
            Exit Function
    End Select
