...
Dim i As Long
    ...
    Select Case index
        ...
        Case 4
            ...
            End If
        Case 5
            If myTargetType = TargetTypePlayer And myTarget <> MyIndex Then
                SendTradeRequest
                ' play sound
                PlaySound Sound_ButtonClick
            Else
...
Private Sub scrlAItem_Change()
    ...
    If Item(scrlAItem.value).Type = ItemTypeCurrency Then
...
Private Sub picInventory_DblClick()
    ...
    If InvNum <> 0 Then
        ...
        ' in bank?
        If InBank Then
            If Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ItemTypeCurrency Then
        ...
        If InTrade > 0 Then
            ...
            For i = 1 To MAX_INV
                If TradeYourOffer(i).num = InvNum Then
                    ' is currency?
                    If Item(GetPlayerInvItemNum(MyIndex, TradeYourOffer(i).num)).Type = ItemTypeCurrency Then
        ...
        If Item(GetPlayerInvItemNum(MyIndex, InvNum)).Type = ItemTypeNone Then Exit Sub
...
Dim bankNum As Long
    ...
    If bankNum <> 0 Then
         If GetBankItemNum(bankNum) = ItemTypeNone Then Exit Sub
         
             If Item(GetBankItemNum(bankNum)).Type = ItemTypeCurrency Then
